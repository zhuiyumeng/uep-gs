"""
RTP 客户端 — 从服务端接收 RTP 流，重组 Gaussian 数据并写为 PLY 文件。

用法:
    python -m transport.client \\
        --host <server_ip> \\
        --port 5005 \\
        --output received.ply
"""
...
from transport.rtp_packet import RTPPacket
from transport.decoder import RTPDecoder, write_ply
...
def main():
    parser = argparse.ArgumentParser(description='3DGS RTP Client')
